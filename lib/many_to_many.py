...
book = Book("Intro to F")
book2 = Book("intro to T")
contract1 = Contract(author, book, "01-01-2025", 50000)
contract2 = Contract(author, book, "01-01-2025", 70000)
contract2 = Contract(author, book2, "21-01-2025", 1000000)

# print(author.contracts())

for contract in author.contracts():
    print(f"Book: {contract.book.title}, Date: {contract.date}, Royalties: {contract.royalties}")

print("Books written by Jerome:")
for book in author.books():
    print(f"{book.title}")


author2 = Author("John")
book21 = Book("BikeLife")

contract = author2.sign_contract(book21, "01-02-2025", 10000090)

print("Books written by John:")
for c in author2.contracts():
    print(f"Book: {c.book.title}, Date: {c.date}, Royalties: {c.royalties}")

print("sorted contracts by date:")
for contract in Contract.contracts_by_date():
    print(f"{contract.date}, {contract.author.name}, {contract.book.title}, {contract.royalties}")